...
if __name__ == '__main__':
  ...
  prob_sintoma_dado_noCancer = 10 / 99999
  prob_noCancer = 1 - prob_cancer

  prob_sintoma = (prob_sintoma_dado_cancer * prob_cancer) + (prob_sintoma_dado_noCancer * prob_noCancer)
